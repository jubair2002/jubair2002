...
| 6 | [Plant Disease Detection ML]([https://github.com/jubair2002/plant-disease-detection-k8s](https://github.com/jubair2002/ml-model-deployment-cicd-gitops.git)) | Manage and deploy plant disease detection ML model app in Kubernetes with full CI/CD and GitOps declarative approach |
---
